...
namespace Re4QuadExtremeEditor.src.Class.MyProperty._EFF_Property
{
    ...
    public class EFF_Table0_Property : BaseProperty, IInternalID
    {
        private const GroupType groupType = GroupType.EFF_Table0;
        ...
        {
            return typeof(EFF_Table0_Property);
        }
        ...
        public EFF_Table0_Property(EFF_Table0_Property prop, bool ForMultiSelection = false)
        {
            PropertyConstructor(prop.InternalID, prop.updateMethods, prop.Methods, ForMultiSelection);
        }

        public EFF_Table0_Property(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Methods Methods, bool ForMultiSelection = false) : base()
        {
