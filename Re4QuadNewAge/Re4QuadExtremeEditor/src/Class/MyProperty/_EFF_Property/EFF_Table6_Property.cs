...
namespace Re4QuadExtremeEditor.src.Class.MyProperty._EFF_Property
{
    ...
    public class EFF_Table6_Property : BaseProperty, IInternalID
    {
        private const GroupType groupType = GroupType.EFF_Table6;
        ...
        {
            return typeof(EFF_Table6_Property);
        }
        ...
        {
            //Line
            ChangePropertyName(nameof(Line), Lang.GetAttributeText(aLang.NewAge_LineArrayDisplayName).Replace("<<Lenght>>", "32"));
        }

        public EFF_Table6_Property(EFF_Table6_Property prop, bool ForMultiSelection = false)
        {
            PropertyConstructor(prop.InternalID, prop.updateMethods, prop.Methods, ForMultiSelection);
        }

        public EFF_Table6_Property(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Methods Methods, bool ForMultiSelection = false) : base()
        {
