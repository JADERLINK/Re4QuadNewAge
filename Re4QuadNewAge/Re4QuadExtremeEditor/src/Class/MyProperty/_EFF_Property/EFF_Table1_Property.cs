...
namespace Re4QuadExtremeEditor.src.Class.MyProperty._EFF_Property
{
    ...
    public class EFF_Table1_Property : BaseProperty, IInternalID
    {
        private const GroupType groupType = GroupType.EFF_Table1;
        ...
        {
            return typeof(EFF_Table1_Property);
        }
        ...
        public EFF_Table1_Property(EFF_Table1_Property prop, bool ForMultiSelection = false)
        {
            PropertyConstructor(prop.InternalID, prop.updateMethods, prop.Methods, ForMultiSelection);
        }

        public EFF_Table1_Property(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Methods Methods, bool ForMultiSelection = false) : base()
        {
