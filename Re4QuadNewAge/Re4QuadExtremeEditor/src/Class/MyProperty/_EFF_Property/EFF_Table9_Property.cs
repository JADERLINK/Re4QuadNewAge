...
namespace Re4QuadExtremeEditor.src.Class.MyProperty._EFF_Property
{
    ...
    public class EFF_Table9_Property : BaseProperty, IInternalID
    {
        private const GroupType groupType = GroupType.EFF_Table9;

        private ushort InternalID = ushort.MaxValue;

        private NewAge_EFF_Table9Entry_Methods Methods = null;
        private UpdateMethods updateMethods = null;

        public override Type GetClassType()
        {
            return typeof(EFF_Table9_Property);
        }
        ...
        public EFF_Table9_Property(EFF_Table9_Property prop, bool ForMultiSelection = false)
        {
            PropertyConstructor(prop.InternalID, prop.updateMethods, prop.Methods, ForMultiSelection);
        }

        public EFF_Table9_Property(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Table9Entry_Methods Methods, bool ForMultiSelection = false) : base()
        {
            PropertyConstructor(InternalID, updateMethods, Methods, ForMultiSelection);
        }

        private void PropertyConstructor(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Table9Entry_Methods Methods, bool ForMultiSelection = false)
        {
        ...
        private const int CategoryID_Table9 = 4;
        #endregion
        ...
        public byte[] Line
        {
            ...
            set
            {
                byte[] _set = new byte[40];
                byte[] insert = value.Take(40).ToArray();
                Line.CopyTo(_set, 0);
        ...
        [CustomCategory(aLang.EFF_Table9_Category)]
        [CustomDisplayName(aLang.EFF_Table9_PositionX_Float_DisplayName)]
        ...
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(1000, CategoryID_Table9)]
        ...
        [CustomCategory(aLang.EFF_Table9_Category)]
        [CustomDisplayName(aLang.EFF_Table9_PositionY_Float_DisplayName)]
        [TypeConverter(typeof(FloatNumberTypeConverter))]
        [FloatNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(1100, CategoryID_Table9)]
        ...
        [CustomCategory(aLang.EFF_Table9_Category)]
        [CustomDisplayName(aLang.EFF_Table9_PositionZ_Float_DisplayName)]
        [TypeConverter(typeof(FloatNumberTypeConverter))]
        [FloatNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(1200, CategoryID_Table9)]
        ...
        [CustomCategory(aLang.EFF_Table9_Category)]
        [CustomDisplayName(aLang.EFF_Table9_PositionX_Hex_DisplayName)]
        [TypeConverter(typeof(HexNumberTypeConverter))]
        [HexNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(false)]
        [DynamicTypeDescriptor.Id(1900, CategoryID_Table9)]
        ...
        [CustomCategory(aLang.EFF_Table9_Category)]
        [CustomDisplayName(aLang.EFF_Table9_PositionY_Hex_DisplayName)]
        [TypeConverter(typeof(HexNumberTypeConverter))]
        [HexNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(false)]
        [DynamicTypeDescriptor.Id(2000, CategoryID_Table9)]
        ...
        [CustomCategory(aLang.EFF_Table9_Category)]
        [CustomDisplayName(aLang.EFF_Table9_PositionZ_Hex_DisplayName)]
        [TypeConverter(typeof(HexNumberTypeConverter))]
        [HexNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(false)]
        [DynamicTypeDescriptor.Id(2100, CategoryID_Table9)]
