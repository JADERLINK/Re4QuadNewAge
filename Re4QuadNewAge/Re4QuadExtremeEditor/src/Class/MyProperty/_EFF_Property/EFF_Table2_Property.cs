...
namespace Re4QuadExtremeEditor.src.Class.MyProperty._EFF_Property
{
    ...
    public class EFF_Table2_Property : BaseProperty, IInternalID
    {
        private const GroupType groupType = GroupType.EFF_Table2;
        ...
        {
            return typeof(EFF_Table2_Property);
        }
        ...
        public EFF_Table2_Property(EFF_Table2_Property prop, bool ForMultiSelection = false)
        {
            PropertyConstructor(prop.InternalID, prop.updateMethods, prop.Methods, ForMultiSelection);
        }

        public EFF_Table2_Property(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Methods Methods, bool ForMultiSelection = false) : base()
        {
